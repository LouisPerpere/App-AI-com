...
def main():
    ...
    try:
        ...
        response = session.post("https://social-gpt-5.preview.emergentagent.com/api/auth/login", json={
            "email": TEST_EMAIL,
        ...
        thumb_url_new_domain = media_collection.count_documents({
            "thumb_url": {"$regex": "https://social-gpt-5.preview.emergentagent.com"}
        })
        ...
        url_new_domain = media_collection.count_documents({
            "url": {"$regex": "https://social-gpt-5.preview.emergentagent.com"}
        })
        ...
        if update_success:
            ...
            print("Le remplacement 'https://claire-marcus.com/uploads/' → 'https://social-gpt-5.preview.emergentagent.com/uploads/' est COMPLET")
        else:
