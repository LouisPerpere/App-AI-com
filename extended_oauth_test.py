            ...
            access_methods = [
                {
                    ...
                    "url": f"https://claire-marcus-app-1.preview.emergentagent.com/api/public/image/{content_id}",
                    "auth": False
                },
                {
                    "name": "Public JPG endpoint", 
                    "url": f"https://claire-marcus-app-1.preview.emergentagent.com/api/public/image/{content_id}.jpg",
                    "auth": False
                },
                {
                    "name": "Protected endpoint",
                    "url": f"https://claire-marcus-app-1.preview.emergentagent.com/api/content/{content_id}/file",
                    "auth": True
                }
            ]
