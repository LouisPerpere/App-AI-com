...
Deep diagnostics against https://saasboost-1.preview.emergentagent.com
...
# Configuration
BASE_URL = "https://saasboost-1.preview.emergentagent.com"
CREDENTIALS = {
...
def test_cors_behavior():
    ...
    try:
        ...
        url = f"{BASE_URL}/api/auth/login-robust"
        headers = {
            'Origin': 'https://social-boost-pwa.preview.emergentagent.com',
