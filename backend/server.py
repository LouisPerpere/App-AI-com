...
async def get_facebook_auth_url(user_id: str = Depends(get_current_user_id_robust)):
    ...
    try:
        ...
        redirect_uri = os.environ.get('FACEBOOK_REDIRECT_URI', 'https://post-genius-13.preview.emergentagent.com/api/social/facebook/callback')
        ...
        # Utiliser le config_id dédié pour Facebook
        config_id = os.environ.get('FACEBOOK_CONFIG_ID_PAGES', os.environ.get('FACEBOOK_CONFIG_ID', '1878388119742903'))
        ...
        return {
            ...
            "config_id": config_id,
            "note": f"Facebook OAuth for Pages only avec config_id dédié: {config_id}"
        }
...
async def get_instagram_auth_url(user_id: str = Depends(get_current_user_id_robust)):
    ...
    try:
        ...
        redirect_uri = os.environ.get('INSTAGRAM_REDIRECT_URI', 'https://post-genius-13.preview.emergentagent.com/api/social/instagram/callback')
...
async def debug_content_pending_simulation():
    ...
    try:
        # Simuler avec l'user_id que nous savons avoir des médias
        ...
        return {
            ...
            "loaded": len(items),
            "note": "Simulation de /api/content/pending"
        }
    except Exception as e:
