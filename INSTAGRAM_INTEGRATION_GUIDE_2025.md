...
- **URL de redirection mise à jour**: `https://insta-automate-3.preview.emergentagent.com/api/social/instagram/callback`
...
2. Ajouter cette URI de redirection **EXACTEMENT** :
   ```
   https://insta-automate-3.preview.emergentagent.com/api/social/instagram/callback
   ```
...
```bash
curl "https://insta-automate-3.preview.emergentagent.com/api/social/instagram/test-auth"
```
