...
Deep diagnostics against https://social-ai-manager-12.preview.emergentagent.com
...
# Configuration
BASE_URL = "https://social-ai-manager-12.preview.emergentagent.com"
CREDENTIALS = {
...
def test_cors_behavior():
    ...
    try:
        ...
        url = f"{BASE_URL}/api/auth/login-robust"
        headers = {
            'Origin': 'https://social-ai-manager-12.preview.emergentagent.com',
