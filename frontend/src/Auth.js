...
import { Eye, EyeOff, LogIn, UserPlus, Sparkles, Shield, Zap, Users, Building, Upload, FileText, Send, CheckCircle, Scale } from 'lucide-react';
...
// Composant Accordéon Mentions Légales - Gris discret
const MentionsLegalesAccordion = () => {
  const [isOpen, setIsOpen] = useState(false);

  return (
    <div className="flex items-start space-x-4 p-4 bg-gray-50/80 backdrop-blur-sm rounded-2xl border border-gray-300">
      ...
      <div className="flex-1">
        ...
        >
          <h3 className="font-bold text-gray-700 mb-1">Mentions légales</h3>
          <svg 
            className={`w-4 h-4 text-gray-500 transition-transform duration-200 ml-2 ${isOpen ? 'rotate-180' : ''}`}
            fill="none" 
            stroke="currentColor" 
            viewBox="0 0 24 24"
          >
        ...
        {isOpen && (
          <div className="mt-2 text-xs text-gray-600 space-y-1 leading-relaxed">
            ...
            <div>
              ...
              <a href="mailto:contact@claire-marcus.com" className="text-gray-700 underline ml-1">Contact</a>
            </div>
            <div>
              Hébergement : <a href="https://emergentagent.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 underline">Emergent</a> (75002 Paris)
            </div>
