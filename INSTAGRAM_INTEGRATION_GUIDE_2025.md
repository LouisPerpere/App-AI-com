...
- **URL de redirection mise à jour**: `https://instamanager-1.preview.emergentagent.com/api/social/instagram/callback`
...
2. Ajouter cette URI de redirection **EXACTEMENT** :
   ```
   https://instamanager-1.preview.emergentagent.com/api/social/instagram/callback
   ```
...
```bash
curl "https://instamanager-1.preview.emergentagent.com/api/social/instagram/test-auth"
```
