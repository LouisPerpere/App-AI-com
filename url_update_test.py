...
class URLUpdateTester:
                        ...
                        "$set": {
                            "thumb_url": {
                                "$replaceOne": {
                                    ...
                                    "replacement": "https://claire-marcus-app-1.preview.emergentagent.com"
                                }
                            }
                        }
                    }
    ...
    def run_all_tests(self):
        ...
        print(f"TÂCHE: Remplacer 'https://claire-marcus.com/uploads/' par 'https://claire-marcus-app-1.preview.emergentagent.com/uploads/'")
        print("=" * 60)
        print()
