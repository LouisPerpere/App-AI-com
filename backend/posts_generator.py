...
Tu réponds EXCLUSIVEMENT au format JSON exact demandé."""
    ...
    async def _generate_posts_with_strategy(self, source_data: Dict, available_content: Dict, 
                                          strategy: Dict, num_posts: int, user_id: str, platform: str = "facebook") -> List[PostContent]:
    ...
    async def _generate_posts_calendar(self, business_context: str, notes_context: str, 
        ...
        try:
            ...
            prompt = f"""Tu dois créer EXACTEMENT {num_posts} posts {platform.title()} pour ce business (PAS PLUS, PAS MOINS).
...
"""
    ...
    async def _generate_single_post(self, visual_content: ContentSource, content_type: str, 
                                   business_context: str, notes_context: str, user_id: str, platform: str = "facebook") -> Optional[PostContent]:
...
"""
    ...
    def _create_posting_schedule(self, posts: List[PostContent], target_month: str, platform: str = "facebook") -> List[PostContent]:
        ...
        for i, post in enumerate(posts):
            ...
            # Assigner la plateforme correcte
