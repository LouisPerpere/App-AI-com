...
def debug_thumbnail_generation():
    ...
    response = requests.post("https://post-restore.preview.emergentagent.com/api/auth/login", json=login_data)
    ...
    response = requests.get(
        "https://post-restore.preview.emergentagent.com/api/content/pending",
        params={'limit': 3},
        headers=headers
    )
