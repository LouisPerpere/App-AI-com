...
class SocialGenieAPITester:
    ...
    def test_demo_checkout_session_starter_monthly(self):
        ...
        checkout_data = {
            ...
            "origin_url": "https://48eac9a4-1f29-46f1-b3a6-a75e871ef31d.preview.emergentagent.com"
        }
    ...
    def test_origin_url_handling(self):
        ...
        test_origins = [
            "https://48eac9a4-1f29-46f1-b3a6-a75e871ef31d.preview.emergentagent.com",
            "https://48eac9a4-1f29-46f1-b3a6-a75e871ef31d.preview.emergentagent.com/",  # with trailing slash
            "http://localhost:3000",
