...
class CriticalMongoDBAnalyzer:
    ...
    def test_api_with_correct_auth(self):
        ...
        try:
            ...
            auth_response = session.post("https://claire-marcus-app.preview.emergentagent.com/api/auth/login", json={
                "email": TEST_EMAIL,
            ...
            if auth_response.status_code == 200:
                ...
                api_response = session.get("https://claire-marcus-app.preview.emergentagent.com/api/content/pending?limit=100")
