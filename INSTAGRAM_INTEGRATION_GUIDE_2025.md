...
- **URL de redirection mise à jour**: `https://smartposter.preview.emergentagent.com/api/social/instagram/callback`
...
2. Ajouter cette URI de redirection **EXACTEMENT** :
   ```
   https://smartposter.preview.emergentagent.com/api/social/instagram/callback
   ```
...
```bash
curl "https://smartposter.preview.emergentagent.com/api/social/instagram/test-auth"
```
