...
class SocialGenieAPITester:
    ...
    def test_demo_checkout_session_starter_monthly(self):
        ...
        checkout_data = {
            ...
            "origin_url": "https://9d9abc32-ca1b-47b1-bc5e-c34b81138b90.preview.emergentagent.com"
        }
    ...
    def test_origin_url_handling(self):
        ...
        test_origins = [
            "https://9d9abc32-ca1b-47b1-bc5e-c34b81138b90.preview.emergentagent.com",
            "https://9d9abc32-ca1b-47b1-bc5e-c34b81138b90.preview.emergentagent.com/",  # with trailing slash
            "http://localhost:3000",
