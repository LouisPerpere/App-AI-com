...
Backend: https://post-genius-13.preview.emergentagent.com/api
...
class InstagramOAuthDiagnostic:
    ...
    def analyze_oauth_parameters(self, auth_url):
        ...
        try:
            ...
            expected_redirect = "https://post-genius-13.preview.emergentagent.com/api/social/instagram/callback"
    ...
    def test_facebook_app_configuration(self):
        ...
        print(f"      🔄 FACEBOOK_REDIRECT_URI: https://post-genius-13.preview.emergentagent.com/auth/facebook/callback")
        print(f"      🎯 Instagram Redirect URI: https://post-genius-13.preview.emergentagent.com/api/social/instagram/callback")
    ...
    def generate_diagnostic_report(self, oauth_params):
        ...
        print(f"         - https://post-genius-13.preview.emergentagent.com/api/social/instagram/callback")
