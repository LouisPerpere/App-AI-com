...
Deep diagnostics against https://content-scheduler-6.preview.emergentagent.com
...
# Configuration
BASE_URL = "https://content-scheduler-6.preview.emergentagent.com"
CREDENTIALS = {
...
def test_cors_behavior():
    ...
    try:
        ...
        url = f"{BASE_URL}/api/auth/login-robust"
        headers = {
            'Origin': 'https://content-scheduler-6.preview.emergentagent.com',
