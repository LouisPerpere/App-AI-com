...
def migrate_filesystem_to_mongodb():
    ...
    for filename in os.listdir(uploads_dir):
        ...
        if os.path.exists(thumb_path):
            ...
            thumb_url = f"https://social-ai-planner-2.preview.emergentagent.com/uploads/thumbs/{thumb_filename}"
        ...
        if existing_doc:
            ...
            media_collection.update_one(
                ...
                {"$set": {
                    ...
                    "url": f"https://social-ai-planner-2.preview.emergentagent.com/uploads/{filename}",
                    "deleted": False
                }}
            )
