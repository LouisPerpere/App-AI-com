...
Deep diagnostics against https://insta-post-engine.preview.emergentagent.com
...
# Configuration
BASE_URL = "https://insta-post-engine.preview.emergentagent.com"
CREDENTIALS = {
...
def test_cors_behavior():
    ...
    try:
        ...
        url = f"{BASE_URL}/api/auth/login-robust"
        headers = {
            'Origin': 'https://insta-post-engine.preview.emergentagent.com',
