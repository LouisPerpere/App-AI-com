...
Deep diagnostics against https://pwa-dashboard-fix.preview.emergentagent.com
...
# Configuration
BASE_URL = "https://pwa-dashboard-fix.preview.emergentagent.com"
CREDENTIALS = {
...
def test_cors_behavior():
    ...
    try:
        ...
        url = f"{BASE_URL}/api/auth/login-robust"
        headers = {
            'Origin': 'https://pwa-dashboard-fix.preview.emergentagent.com',
