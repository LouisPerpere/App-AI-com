...
class SocialGenieAPITester:
    ...
    def test_demo_checkout_session_starter_monthly(self):
        ...
        checkout_data = {
            ...
            "origin_url": "https://virtual-keyboard-fix.preview.emergentagent.com"
        }
    ...
    def test_origin_url_handling(self):
        ...
        test_origins = [
            "https://virtual-keyboard-fix.preview.emergentagent.com",
            "https://virtual-keyboard-fix.preview.emergentagent.com/",  # with trailing slash
            "http://localhost:3000",
