...
// Import icons
import { Building, Sparkles, Crown, Upload, ImageIcon, FileText, X, Edit, CalendarIcon, Target, LogOut, Check, Send, Clock, ChevronLeft, ChevronRight, CreditCard, Settings } from 'lucide-react';
              ...
              <CardContent>
                <div className="text-center py-20 card-glass rounded-3xl border-2 border-dashed border-purple-300">
                  ...
                  <Button
                    ...
                    className="btn-gradient-primary inline-flex items-center px-4 py-3 text-base font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 max-w-xs"
                  >
