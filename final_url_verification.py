...
def main():
    ...
    try:
        ...
        response = session.post("https://social-pub-hub.preview.emergentagent.com/api/auth/login", json={
            "email": TEST_EMAIL,
        ...
        if update_success:
            ...
            print("Le remplacement 'https://claire-marcus.com/uploads/' → 'https://social-pub-hub.preview.emergentagent.com/uploads/' est COMPLET")
        else:
